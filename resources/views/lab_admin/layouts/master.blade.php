...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-theme/font-awesome/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-theme/font-awesome/css/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-theme/font-awesome/css/fontawesome.css') }}">
...
<body>
    ...
    <!--  Loader Ends -->
    @include('lab_admin.layouts.header')
    <!--  Main Container Starts  -->
    <div class="main-container" id="container">
        <div class="overlay"></div>
        <div class="search-overlay"></div>
        <div class="rightbar-overlay"></div>
        @include('lab_admin.layouts.side_bar')

        <div id="content" class="main-content">
            @yield('content')

        </div>
        @include('lab_admin.layouts.right_bar')
    </div>
    ...
    <script src="{{ asset('admin-theme/font-awesome/all.js')}}"></script>
    <script src="{{ asset('admin-theme/font-awesome/all.min.js')}}"></script>
    <script src="{{ asset('admin-theme/font-awesome/fontawesome.js')}}"></script>
    <script src="{{ asset('admin-theme//font-awesome/fontawesome.min.js')}}"></script>
